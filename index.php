      ...
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="text-center">
            <h1 class="text-balance text-4xl font-semibold tracking-tight text-gray-900 md:text-7xl">Capture ideas,
              Organize thoughts, Elevate creativity.</h1>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">Alpha Notes - Save Your Notes And
